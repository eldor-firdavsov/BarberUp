    ...
    return (
        ...
        <section className="mt-10 mx-auto">
            <div className="flex flex-col text-center ">
                ...
                <h1 className="text-[36px] font-bold text-[#1D0065] leading-none my-5">Login to your <br />account</h1>
            ...
            <div className="flex flex-col justify-items-center mt-3">
                <div className="ml-38 leading-none  text-right">
                    <p className="text-[11px] text-[#7D7483]">Don't have an account?</p>
                    <Link to="/register" className="text-[11px] font-semibold text-[#1D0065] ">Sign Up</Link>
                </div>
            </div>
        </section>
